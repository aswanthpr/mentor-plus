...
const mentorAuthorization = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!refreshToken || !(0, jwt_utils_1.verifyRefreshToken)(refreshToken, "mentor")) {
        ...
        const mentorData = yield mentorModel_1.default.findById((_b = decode === null || decode === void 0 ? void 0 : decode.result) === null || _b === void 0 ? void 0 : _b.userId);
        ...
        if (((_c = decode === null || decode === void 0 ? void 0 : decode.result) === null || _c === void 0 ? void 0 : _c.role) !== "mentor") {
            res
                .status(httpStatusCode_1.Status === null || httpStatusCode_1.Status === void 0 ? void 0 : httpStatusCode_1.Status.Unauthorized)
