...
const mentorAuthorization = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        if (!authHeader || !authHeader.startsWith('Bearer')) {
            res.status(httpStatusCode_1.Status.Unauthorized).json({ success: false, message: "Unauthorized. No token provided.", user: false });
            return;
        }
        const token = authHeader === null || authHeader === void 0 ? void 0 : authHeader.split(' ')[1];
        if (!token) {
            res.status(httpStatusCode_1.Status.Unauthorized).json({ success: false, message: "You do not have permission to access this resource.", user: false });
            return;
        }
        //jwt verifying
        ...
        if ((decode === null || decode === void 0 ? void 0 : decode.role) !== "mentor") {
            res
                .status(httpStatusCode_1.Status === null || httpStatusCode_1.Status === void 0 ? void 0 : httpStatusCode_1.Status.Unauthorized)
...
exports.default = mentorAuthorization;
