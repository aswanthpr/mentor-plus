...
mentor_Router.patch(`/profile/image_change`, (0, authorizeUser_1.default)('mentor'), multer_util_1.default.fields([{ name: "profileImage", maxCount: 1 }]), __mentorController.mentorProfileImageChange.bind(__mentorController));
