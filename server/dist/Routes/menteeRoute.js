...
mentee_Router.patch(`/profile/change_profile`, (0, authorizeUser_1.default)('mentee'), multer_util_1.default.fields([{ name: "profileImage", maxCount: 1 }]), __menteeController.profileChange.bind(__menteeController));
