...
const menteeAuthMiddleware_1 = __importDefault(require("../Middleware/menteeAuthMiddleware"));
...
mentee_Router.get(`/explore`, menteeAuthMiddleware_1.default, __menteeController.exploreData.bind(__menteeController));
mentee_Router.get(`/profile`, menteeAuthMiddleware_1.default, __menteeController.menteeProfile.bind(__menteeController));
...
mentee_Router.delete(`/qa/delete/:questionId`, menteeAuthMiddleware_1.default, __qaController.deleteQuestion.bind(__qaController));
mentee_Router.post(`/qa/create-answer`, menteeAuthMiddleware_1.default, __qaController.createNewAnswer.bind(__qaController));
...
mentee_Router.get(`/notification`, menteeAuthMiddleware_1.default, __notificationController.getNotification.bind(__notificationController));
...
mentee_Router.get("/turn-credentials", menteeAuthMiddleware_1.default, __bookingController.turnServerConnection.bind(__bookingController));
