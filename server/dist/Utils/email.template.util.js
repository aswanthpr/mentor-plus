...
exports.generateMentorVerifiedEmailTemplate = generateMentorVerifiedEmailTemplate;
function generateOtpEmailTemplate(otp, email) {
    return {
        to: email,
...
function generateMentorVerifiedEmailTemplate(mentorName, email) {
    return {
        to: email,
