    ...
    mentorApply(mentorData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const imageUrl = yield (0, cloudinary_config_1.uploadImage)(profileImage === null || profileImage === void 0 ? void 0 : profileImage.buffer);
                const fileUrl = yield (0, cloudinary_config_1.uploadFile)(resume === null || resume === void 0 ? void 0 : resume.buffer, resume === null || resume === void 0 ? void 0 : resume.originalname);
                if (!imageUrl || !fileUrl) {
