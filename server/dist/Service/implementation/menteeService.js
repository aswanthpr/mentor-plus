...
class menteeService {
    ...
    menteeProfile(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
                const decode = (0, index_1.verifyAccessToken)(refreshToken, 'mentee');
    ...
    passwordChange(currentPassword, newPassword, _id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const hashPass = yield (0, index_1.hash_pass)(newPassword);
    ...
    profileChange(image, id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const profileUrl = yield (0, cloudinary_config_1.uploadImage)(image === null || image === void 0 ? void 0 : image.buffer);
    ...
    refreshToken(refresh) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const decode = (0, index_1.verifyRefreshToken)(refresh, "mentee");
