...
export default interface IauthService {
  ...
  mainLogin(email: string, password: string): Promise<{ success: boolean, message: string,status:number, refreshToken?: string, accessToken?: string, role?: string ,user?:IuserDetailsHeader}>
  ...
  mentorLogin(email: string, password: string): Promise<{ success: boolean, message: string, status: number, refreshToken?: string, accessToken?: string,user?:IuserDetailsHeader }>;
  ...
  googleAuth(user:Imentee|undefined): Promise<{ success: boolean, message: string,status:number,accessToken?:string ,refreshToken?:string,user?:MenteeDTO}>
}
