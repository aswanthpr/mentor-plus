      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="hidden lg:block w-64 ml-8 flex-shrink-0">
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 sticky top-24">
            <h2 className="text-lg font-semibold text-gray-900 mt-3 mb-6">Filters</h2>
            <Filters filters={filters} onFilterChange={setFilterVal} />
          </div>
        </div>
        ...
        <div className="flex-1">
          <div className="flex flex-col sm:flex-row gap-2 mb-2">
            ...
            <button onClick={() => setShowFilters(true)} className="lg:hidden px-4 mt-6 flex items-center justify-center gap-2 xss:mx-1 border border-gray-300 rounded-lg hover:bg-gray-50 py-2">
          ...
          <InfiniteScroll
            ...
            hasMore={hasMore}
            loader={<h4 className="text-center my-4">Loading more mentors...</h4>}
            endMessage={<p className=" flex justify-center text-center my-4 text-gray-500"><CircleAlertIcon  className="w-6 mr-1"/> No more mentors to load. </p>}
          >
