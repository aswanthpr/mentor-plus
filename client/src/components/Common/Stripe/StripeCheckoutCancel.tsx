  ...
  return (
    <div className="h-screen flex justify-center items-center bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-md text-center max-w-md">
        ...
        <p className="text-gray-600 my-2">Your payment has been cancelled. You can continue or try again later.</p>
        <div className="py-10">
          <Link to="/mentee/home" className="px-12 bg-red-600 hover:bg-red-500 text-white font-semibold py-3 rounded-lg">
            Go to Home 
          </Link>
        </div>
      </div>
